                                ...
                                <AnimateOnScroll animation="fadeInDown" speed="normal">
                                    <div className="d-flex flex-column gspace-2">
                                        <div className="sub-heading">
                                            ...
                                            <span>Why Choose Resometa</span>
                                        </div>
                                        <h2 className="title-heading">Your Success is Our Mission</h2>
                                        <p className="mb-0">In the fast-paced digital world, choosing the right marketing partner makes all the difference. At Resometa, we don’t just create campaigns—we craft strategies that deliver measurable success.</p>
                                    </div>
                                </AnimateOnScroll>
                                <div className="image-container">
                                    <img src="/assets/images/ChooseUs/chooseUs.webp" alt="Why Choose Us Image" loading="lazy" className="chooseus-img" />
                                            ...
                                            <div className="card-chooseus-cta-wrapper">
                                                <AnimateOnScroll animation="fadeInUp" speed="normal">
                                                    <div className="card card-chooseus-cta">
                                                        <h5>Partner with Resometa & take your brand to the next level.</h5>
